---
title: Usage
description: "Laravel queue dashboard usage: search job execution history, cancel running jobs, block job classes, retry failures and set up stale-job alerts in Deck."
head:
  - tag: title
